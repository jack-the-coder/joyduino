 ...
 * Modified by: Shawn Hymel (SparkFun Electronics) and others (see note below)
 * 
 ...
 * 
 * Some additional functionality has been added by jack-the-coder. It is believed that 
 * the original author will allow modifications of this code to be distributed, but 
 * if that is not the case, please make an issue on this GitHub repository. 
 */
